...
{    
    //inicio da criação de variáveis/string
	 ...
	 file = fopen(arquivo, "a"); //cria o arquivo e o "a" significa atualizar informação
	 ...
	 file = fopen(arquivo, "a"); //cria o arquivo e o "a" significa coletar informação
	 ...
	 file = fopen(arquivo, "a"); //cria o arquivo e o "a" atualizar informação
	 fprintf(file,","); //salva o valor da variável
	 fclose(file); //fecha o arquivo
